...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('university', '0004_professor_user_student_user'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='student',
            name='user',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='university.customuser'),
        ),
    ]
